...
document.addEventListener('DOMContentLoaded', () => {
    // 1. DATA DEFINITION (Standardized Spouse Gaps: 160px)
    const centerX = 1500;
    const centerY = 1500;
    
    const FAMILY_DATA = [
        // LEVEL -2: Grandparents (Gap: 160px)
        { id: 101, name: "Kakek Paternal", gender: "male", isDeceased: true, level: -2, pos: { x: -240, y: -340 }, isBlood: true },
        { id: 102, name: "Nenek Paternal", gender: "female", isDeceased: true, level: -2, pos: { x: -80, y: -340 }, spouseId: 101 },
        
        { id: 103, name: "Kakek Maternal", gender: "male", isDeceased: false, level: -2, pos: { x: 80, y: -340 }, isBlood: true },
        { id: 104, name: "Nenek Maternal", gender: "female", isDeceased: true, level: -2, pos: { x: 240, y: -340 }, spouseId: 103 },
        
        // LEVEL -1: Parents (Gap: 160px)
        { id: 201, name: "Budi (Ayah)", gender: "male", isDeceased: false, level: -1, pos: { x: -80, y: -170 }, parents: [101, 102], isBlood: true },
        { id: 202, name: "Wati (Ibu)", gender: "female", isDeceased: false, level: -1, pos: { x: 80, y: -170 }, parents: [103, 104], spouseId: 201 },
        
        // LEVEL 0: Center (Gap: 160px)
        { id: 1, name: "Fayyadh (Anda)", gender: "male", isDeceased: false, level: 0, pos: { x: 0, y: 0 }, parents: [201, 202], isMe: true, isBlood: true },
        { id: 2, name: "Sarah", gender: "female", isDeceased: false, level: 0, pos: { x: 160, y: 0 }, spouseId: 1 },
        { id: 3, name: "Adit (Adik)", gender: "male", isDeceased: false, level: 0, pos: { x: -160, y: 0 }, parents: [201, 202], isBlood: true },

        // LEVEL 1: Children (Gap: 160px)
        { id: 301, name: "Rian (Anak)", gender: "male", isDeceased: false, level: 1, pos: { x: -80, y: 170 }, parents: [1, 2], isBlood: true },
        { id: 302, name: "Siska", gender: "female", isDeceased: false, level: 1, pos: { x: 80, y: 170 }, spouseId: 301 },

        // LEVEL 2: Grandchildren
        { id: 401, name: "Cucu 1", gender: "male", isDeceased: false, level: 2, pos: { x: 0, y: 340 }, parents: [301, 302], isBlood: true }
    ];
    ...
    function renderTree() {
        ...
        // Draw Lines First (Z-index management)
        ...
        FAMILY_DATA.forEach((member) => {
            ...
            const isMeClass = member.isMe ? 'ring-4 ring-primary ring-offset-4 ring-offset-transparent' : '';
    ...
    function createLine(x1, y1, x2, y2, isMarriage = false) {
        ...
        if (isMarriage) {
            ...
            // Descending Orthogonal logic
            const splitY = y1 + (y2 - y1) * 0.5; // Split at 50%
    ...
    // Initial Pan to Center (1500, 1500)
    setTimeout(() => {
